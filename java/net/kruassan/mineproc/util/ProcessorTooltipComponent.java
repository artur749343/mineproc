...
public class ProcessorTooltipComponent implements TooltipComponent {
    ...
    public ProcessorTooltipComponent(BundleTooltipData data) {
    ...
    private void drawSlot(int x, int y, int index, boolean shouldBlock, DrawContext context, TextRenderer textRenderer) {
        if (index >= this.inventory.size()) {
            this.draw(context, x, y, shouldBlock ? net.kruassan.mineproc.util.ProcessorTooltipComponent.Sprite.BLOCKED_SLOT : net.kruassan.mineproc.util.ProcessorTooltipComponent.Sprite.SLOT);
            return;
        }
        ItemStack itemStack = this.inventory.get(index);
        this.draw(context, x, y, net.kruassan.mineproc.util.ProcessorTooltipComponent.Sprite.SLOT);
    ...
    private void draw(DrawContext context, int x, int y, net.kruassan.mineproc.util.ProcessorTooltipComponent.Sprite sprite) {
