...
public class GetterScreen extends HandledScreen<GetterScreenHandler> {
...
//    protected Console searchBox;
    public GetterScreen(GetterScreenHandler handler, PlayerInventory inventory, Text title){
