...
public class ComputerScreen extends HandledScreen<ComputerScreenHandler> {
    private static final Identifier TEXTURE=new Identifier(Mineproc.MOD_ID, "textures/gui/computer_gui.png");
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(TEXTURE, x, y-32, 0, 0, backgroundWidth, backgroundHeight+32);
    }
    @Override
